...
parameters:
  ...
  -
    tag: A
    optional: true
    description: An absolute or relative coordinate on the A axis (in current units). The A axis descibes the angular position of a rotational axis parallel to the X axis.
    values:
      -
        tag: pos
        type: float
  -
    tag: B
    optional: true
    description: An absolute or relative coordinate on the Y axis (in current units). The B axis descibes the angular position of a rotational axis parallel to the Y axis.
    values:
      -
        tag: pos
        type: float
  -
    tag: C
    optional: true
    description: An absolute or relative coordinate on the Z axis (in current units). The C axis descibes the angular position of a rotational axis parallel to the Z axis.
    values:
      -
        tag: pos
        type: float
  -
    tag: U
    optional: true
    description: An absolute or relative coordinate on the U axis (in current units). By convention, the U axis descibes the position of a secondary linear axis parallel to the X axis.
    values:
      -
        tag: pos
        type: float
  -
    tag: V
    optional: true
    description: An absolute or relative coordinate on the V axis (in current units). By convention, the V axis descibes the position of a secondary linear axis parallel to the Y axis.
    values:
      -
        tag: pos
        type: float
  -
    tag: W
    optional: true
    description: An absolute or relative coordinate on the W axis (in current units). By convention, the W axis descibes the position of a secondary linear axis parallel to the Z axis.
    values:
      -
        tag: pos
        type: float
