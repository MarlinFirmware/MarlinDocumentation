...
This command performs an automatic calibration of backlash, positional errors, and nozzle offset by touching the nozzle to the sides of a bed-mounted tool setter (e.g., an electrically-conductive object like a cube, washer or bolt) that is connected to the CALIBRATION_PIN.
